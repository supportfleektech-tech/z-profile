...
export const SPIN_MODULES: SpinModule[] = [
  ...
  /* ───────────────────────────── CRB ───────────────────────────── */
  {
    ...
    pricedItemId: 'kyc-metropol-standard',
    fidelity: 'full',
    notes: 'Spin is integrated with Metropol and TransUnion for a holistic bureau view. Proposal tiers: Score Only 85, Standard 150, Full 300 (0–500 band).',
  },
  {
    id: 'spin-metropol-score',
    ...
    responseFields: [
      { name: 'code', description: '"200.001"' },
      { name: 'data', description: 'Score payload (Score Only tier)' },
    ],
    pricedItemId: 'kyc-metropol-score',
    fidelity: 'section-only',
    notes: 'Score Only tier of the Metropol APIs pricing table; same search family as the summary report.',
  },
  {
  ...
  },
  {
    ...
    fidelity: 'full',
    notes: 'Proposal products: Score Only 50, Comprehensive Report 350, CRB Status 2,000 (per query, un-banded).',
  },
  {
    id: 'spin-ci-score',
    ...
    identifierLabel: 'National ID number',
    responseFields: [
      { name: 'data', description: 'Score payload (Score Only product)' },
    ],
    pricedItemId: 'kyc-ci-score',
    fidelity: 'section-only',
    notes: 'CreditInfo Score Only product; report_type param selects the tier.',
  },
  {
    id: 'spin-ci-status',
    ...
    identifierLabel: 'National ID number',
    responseFields: [
      { name: 'data', description: 'CRB status / clearance payload' },
    ],
    pricedItemId: 'kyc-ci-status',
    fidelity: 'section-only',
    notes: 'CreditInfo CRB Status product (KES 2,000 per query).',
  },
